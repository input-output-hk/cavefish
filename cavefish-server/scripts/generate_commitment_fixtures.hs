...
import WBPS.Core.Session.Steps.Demonstration.Artefacts.Commitment.Build (Commitment (..), CommitmentPayload (..), Input (..), build)
...
import WBPS.Core.Session.Steps.Demonstration.Artefacts.Scalars (Scalars (Scalars, ekPowRho), compute)
