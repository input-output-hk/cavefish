...
-- | Module for structured logging using contra-tracer and JSON output.
-- Offers functions to create tracers that log messages with metadata and handle logging on failures.
module Core.Logging (
  -- * Tracer
  Tracer (..),
  natTracer,
