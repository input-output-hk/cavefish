...
--   Haskell code and `packages/wbps/setup/relation/relation.circom`.
...
--   `packages/wbps/setup/relation/relation.circom`. Any change requires rebuilding the circuit.
...
--   `packages/wbps/setup/relation/relation.circom`. See `scripts/inspect_tx_inputs_window.hs`
