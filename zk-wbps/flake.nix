...

      {
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            elif "$PWD/../prototype/scripts/install-babyjubjub-keygen.sh"; then
              # prebuilt binary matching this host (or native build), see the script
              export PATH=$PWD/../prototype/.tools/babyjubjub-keygen/bin:$PATH
            else
