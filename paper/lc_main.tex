...
% \makeatletter
% \newenvironment{algcompatible*}[1][0]{%
%   \algcompatible[#1]%
% }{%
%   \endalgcompatible
% }
...
\makeatletter
% Define the keywords (as before)
\newcommand{\algorithmicupon}{\textbf{upon}}
\newcommand{\algorithmicendupon}{\textbf{end upon}}

% Define the \UPON command (as before)
\newcommand{\UPON}[1]{\ALC@it\algorithmicupon\ {#1} \begin{ALC@if}}

% CORRECTED \ENDUPON Definition:
% 1. \end{ALC@if} closes the inner block.
% 2. \ALC@it starts a new line.
% 3. \algorithmicendupon prints the text.
\newcommand{\ENDUPON}{\end{ALC@if}\ALC@it\algorithmicendupon}
\makeatother
...
\newcommand{\Ideal}{\mathcal{F}_{\fun{Cavefish}}}
\newcommand{\Real}{\Pi_{\fun{Cavefish}}}
